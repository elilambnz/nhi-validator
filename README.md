...
[![Build Status](https://img.shields.io/github/workflow/status/elilambnz/nhi-validator/CI?style=flat-square&label=CI)](https://github.com/elilambnz/nhi-validator/actions?query=workflow%CI+branch%3Amain)
